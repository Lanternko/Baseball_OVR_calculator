...
// 聯盟平均（attr=70 ≈ 平均）
const LEAGUE_AVG = { BB: 0.085, K: 0.225, BA: 0.242, SLG: 0.385, OBP: 0.315 };

// 投手常數表（stat -> attr）
const PITCHER_CONTROL_TABLE = [
  [0.015, 150], [0.040, 99], [0.055, 85], [0.080, 70], [0.095, 40], [0.115, 20], [0.150, 10], [0.250, 1]
];
const PITCHER_STRIKEOUT_TABLE = [
  [0.080, 1], [0.140, 20], [0.160, 40], [0.230, 70], [0.260, 85], [0.330, 99], [0.380, 120], [0.450, 150]
];
const PITCHER_STUFF_TABLE = [
  [0.160, 150], [0.195, 99], [0.216, 85], [0.242, 70], [0.265, 40], [0.295, 20], [0.350, 10], [0.450, 1]
];
const PITCHER_SUPPRESSION_TABLE = [
  [0.200, 150], [0.300, 99], [0.335, 85], [0.385, 70], [0.435, 40], [0.490, 20], [0.600, 10], [0.800, 1]
];
